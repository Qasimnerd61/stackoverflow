<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Questions.aspx.cs" Inherits="StackOverFlow.PresentationLayer.Questions" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav ms-auto d-flex flex-row">
                        ...
                        <div><asp:Button ID="AskQuestion" class="btn btn-primary ms-2" runat="server" Text="Ask-Question" OnClick="AskQuestion_Click"/></div>
                         <div><asp:Button ID="Button1" class="btn btn-primary ms-2" runat="server" Text="My-Questions" OnClick="MyQuestions_Click"/></div>
     ...
     <script src="scripts/QuestionPage.js"></script>
</body>
</html>
